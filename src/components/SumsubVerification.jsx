            ...
            return (
                <div className="status-box error">
                    ...
                    <div>
                        ...
                        <button onClick={fetchToken} className="rl-btn rl-btn-outline-accent mt-4">Try Again</button>
                    </div>
                </div>
            );
        default: // Not started or Initial
            return (
                <div className="start-box">
                    ...
                    <button onClick={fetchToken} disabled={status === 'loading'} className="rl-btn rl-btn-primary size-lg">
